//
//  CoachingPreviewSophomore.swift
//  CollegeApp101
//
...
class CoachingPreviewSophomore : UIViewController {
    ...
    internal func pushDownVC(vc : UIViewController, dur : NSTimeInterval){
        UIView.animateWithDuration(dur, animations: {
            ...
            self.view.frame = CGRect(x: 0.0, y: MainPanels.Constants.navBarHeightWithStatusBar, width: vc.view.frame.width, height: vc.view.frame.height)
        })
    }
